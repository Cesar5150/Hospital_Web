                    ...
                    <table id="tablaTratamientos" class="table table-primary table-bordered table-condesed" style="width: 100%">
                        <thead class="text-center">
                            ...
                            while ($persona = $consulta->fetch_assoc()) {
                                ?>
                            <tr>
                                <td><?php echo $persona['IdTratamiento'];?></td>
    ...
    <div class="modal fade" id="modalTratamiento" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <!-- FORMULARIO DE INSCRIPCION DE TRATAMIENTOS-->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Digite el ID del tratamiento" id="IdTratamiento">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="col-form-label">NOMBRE:</label>
                                    <input type="text" class="form-control" placeholder="Digite el tratamiento" id="nom_t">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="col-form-label">COSTO:</label>
                                    <input type="text" class="form-control" placeholder="Digite el costo" id="costo">
                                </div>
                            </div>

                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                <button type="submit" id="btnGuardar" class="btn btn-primary">Ingresar Tratamiento</button>
                            </div>
                </form>
            </div>
        </div>
